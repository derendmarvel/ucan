        ...
        <div class="container-fluid">
            <div class="row invitation-background header align-items-center align-middle">
                <div class="col-12">
                    ...
                    <form action = "{{ route('guestSearch') }}" method = "GET" class = "form-inline w-50 d-flex gap-2 pt-0 pb-3"> 
                        <input class = "form-control" type = "search" name = "search" placeholder = "Search">
                        <button type = "submit" class = "btn btn-outline-success"> Search </button>
                    </form>

                    <div class="table-responsive">
                        <table class="table table-striped table-hover rounded-5 w-100">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
                    ...
                    <form action = "{{ route('vipSearch') }}" method = "GET" class = "form-inline w-50 d-flex gap-2 pt-0 pb-3"> 
                        <input class = "form-control" type = "search" name = "search" placeholder = "Search">
                        <button type = "submit" class = "btn btn-outline-success"> Search </button>
                    </form>
